...
holder.setIteAmount("Allocate amount: $"+model.getAmount());
...
switch(model.getItem())
{
    ...
    case"Entertainment":
        ...
        break;
    case"Education":
        holder.imageView.setImageResource(R.drawable.edu);
        break;
    case"Charity":
        holder.imageView.setImageResource(R.drawable.charirty);
        break;
    case"Apparel":
...
TextView item=mView.findViewById(R.id.item);
        ...
        public void setIteAmount(String itemAmount)
       {
